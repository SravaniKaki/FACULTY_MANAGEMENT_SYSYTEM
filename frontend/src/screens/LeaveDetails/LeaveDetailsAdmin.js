...
import SingleLeaveAdmin from './SingleLeaveAdmin';

function LeaveDetailsAdmin() {
        ...
        if(emp){
            ...
            .then(response => {
                ...
                for(var i=0;i<response.data.length;i++){
                    ...
                    if(emp.Department == response.data[i].Department && response.data[i].Status == "Approved by HOD"){
                        console.log("called");
...
export default LeaveDetailsAdmin