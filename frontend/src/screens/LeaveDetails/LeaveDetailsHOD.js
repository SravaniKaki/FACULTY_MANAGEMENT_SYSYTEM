...
import SingleLeaveHOD from './SingleLeaveHOD';

function LeaveDetailsHOD() {
        ...
        if(emp){
            ...
            .then(response => {
                ...
                for(var i=0;i<response.data.length;i++){
                    ...
                    if(emp.Department == response.data[i].Department && response.data[i].Status == "Pending"){
                        console.log("called");
...
export default LeaveDetailsHOD